...
- [x] Loginfehler „E-Mail oder Passwort ungültig“ anhand von aktivem Konto, Passwortstatus, Rate-Limit und Anmeldeweg sicher eingrenzen
- [x] Betroffenen Portalzugang ohne Klartextpasswort geprüft; keine Korrektur oder Passwortneuausstellung erforderlich, da derselbe Zugang neun Sekunden später erfolgreich war
- [x] Erfolgreichen Login und unveränderte Rate-Limit-/Fehlerbehandlung über Auditnachweis sowie 28 Portaltests regressionssicher prüfen
- [x] Erfolgreichen und fehlerhaften Passwortvergleich für ein aktives Portal-Konto unabhängig von Produktivdaten regressionstesten
- [x] Erfolgreichen `portal.login`-Routerpfad mit aktivem Testkonto und gesetztem Sitzungscookie nachweisen
- [x] Fehlgeschlagenen `portal.login`-Routerpfad bei falschem Passwort mit der generischen Fehlermeldung nachweisen
