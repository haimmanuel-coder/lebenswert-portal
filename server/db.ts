...
export async function getAllMitarbeiter() {
  ...
  return db.select({
    ...
    zuschlaege: (mitarbeiter as any).zuschlaege,
    probezeit: (mitarbeiter as any).probezeit,
    probeEnde: (mitarbeiter as any).probeEnde,
    kuendigungsfrist: (mitarbeiter as any).kuendigungsfrist,
    arbeitszeitmodell: (mitarbeiter as any).arbeitszeitmodell,
    sozialversicherungsnummer: (mitarbeiter as any).sozialversicherungsnummer,
    steuerklasse: (mitarbeiter as any).steuerklasse,
    steueridentnummer: (mitarbeiter as any).steueridentnummer,
    iban: (mitarbeiter as any).iban,
