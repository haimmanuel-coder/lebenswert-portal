...
const TABLE_DEFINITIONS: string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS \`besuchsberichte\` (
    ...
    \`taetigkeiten\` text NULL,
    \`beobachtungen\` text NULL,
    \`besonderheiten\` text NULL,
    \`naechsteSchritte\` text NULL,
    \`pflegegradSnapshot\` varchar(20) NULL,
    \`fahrtKilometer\` decimal(6,1) NULL,
    \`fahrtVonOrt\` varchar(200) NULL,
    \`fahrtNachOrt\` varchar(200) NULL,
