  ...
  return (
    <div className="page-enter">
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 13, color: "#6b7280", marginTop: 2 }}>Seniorenassistenz Bernhardt – Verwaltung</div>
      </div>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 16 }}>
        {[
          ...
          { key: "compliance" as AdminTab, label: "🚦 Admin-Dashboard · Compliance" },
          { key: "compliance-gesamt" as AdminTab, label: "📊 Compliance-Gesamt" },
          { key: "arbeitssicherheit" as AdminTab, label: "⛑️ Arbeitssicherheit" },
          { key: "as-dashboard" as AdminTab, label: "⛑️ Admin-Dashboard · Arbeitssicherheit" },
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              ...
              <button onClick={() => { const ids = druckbareZugangskartenMitarbeiter.map(ma => ma.id); if (ids.length === 0) { toast.error("Keine aktiven Mitarbeiter für Zugangskarten gefunden."); return; } if (window.confirm(`Für ${ids.length} aktive Mitarbeiter werden neue Startpasswörter erstellt. Die bisherigen Passwörter verlieren danach ihre Gültigkeit. Fortfahren?`)) startpasswoerterErstellen.mutate({ mitarbeiterIds: ids }); }} disabled={startpasswoerterErstellen.isPending} title="Einmalige Startpasswörter für alle aktiven Mitarbeiter erzeugen und danach als Zugangskarten anzeigen" style={{ padding: "8px 12px", background: "#7c3aed", color: "#fff", border: "none", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: "pointer", opacity: startpasswoerterErstellen.isPending ? .7 : 1 }}>{startpasswoerterErstellen.isPending ? "Erstelle …" : "🔐 Zugangskarten erstellen"}</button>
